  ...
  return (
    ...
    >
      <div>
        ...
        <p className="text-xl text-white-1 font-semibold text-center mt-9"> Manage all your multichain activities effortlessly in one place. Streamline your multichain management with a single, convenient solution.</p>
      </div>

      <div className="flex items-center justify-center gap-8">
          <Button2>Add an Account</Button2>     
          <button className="bg-[#0039a6] px-8 py-2 rounded-md"> <Link href="/swap">Connect</Link></button>
      </div>
    </main>
  );
}
