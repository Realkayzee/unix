  ...
  return (
      <>
          <div className='bg-white-1 rounded-3xl w-[1100px] mx-auto'>
            ...
            <h2 className='text-center text-3xl font-bold mt-12 mb-3'>Token Account Bound</h2>
            ...
            <div className='bg-white-1 rounded-3xl w-[1100px] mx-auto border-hero border-2 text-hero'>
              <div className='p-8 flex flex-col gap-4'>
                  ...
                  {Array.from({ length: 4 }).map((_, index) => (
                      <div className='flex items-center justify-between rounded-2xl border-hero border-2 p-4'>
                          <p>
                              <span className='mr-4'>{index}</span>0x85f452bAeC34a3475464Ba7130081b587BbF0472
                          </p>
              ...
              <p className='text-center m-2'>Missing TBA? <a className="underline" href='/'>add TBA</a></p>
            </div>
      </>
  )
}
